...
public class CreateRecommendationsActivity {
    ...
    public List<Recommendation> handleRequest(CreateRecommendationsRequest input, Context context) {
        ...
        PaginatedQueryList<FollowEdge> followEdgeDaoPaginatedQueryList= this.followEdgeDao.getAllFollowers(input.getUsername());

        List<String> follows = followEdgeDaoPaginatedQueryList.stream()
